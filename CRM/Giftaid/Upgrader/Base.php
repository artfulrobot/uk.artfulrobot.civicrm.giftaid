 ...
 */
class CRM_Giftaid_Upgrader_Base {

  /**
   * @var CRM_Giftaid_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Giftaid_Upgrader(
        'uk.artfulrobot.civicrm.giftaid',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Giftaid_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Giftaid_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
